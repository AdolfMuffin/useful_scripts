...
create_json_raid () {
    controller_qty=$(($($storcli show ctrlcount | grep "Controller Count =" | awk '{ print $4 }' | tail -1)-1))
    echo "{ "\"data"\":["
...
create_json_physical () {
    pdisk_qty=$(($($storcli /call/dall show all | grep "Total Drive Count =" | awk '{ print $5 }' | tail -1)-1))
    echo "{ "\"data"\":["
...
create_json_virtual () {
    vdisk_qty=$(($($storcli /call/dall show all | grep "Total VD Count =" | awk '{ print $5 }' | tail -1)-1))
    echo "{ "\"data"\":["
...
case "$1" in
    ...
    ###
    "get_status_physical") cat /tmp/storcli_cache/pdisk_cache.json | grep "\"$object_id"\" | awk '{ print $3 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_smart_physical") cat /tmp/storcli_cache/pdisk_cache.json | grep "\"$object_id"\" | awk '{ print $4 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_model_physical") cat /tmp/storcli_cache/pdisk_cache.json | grep "\"$object_id"\" | awk '{ print $6 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_temp_physical") cat /tmp/storcli_cache/pdisk_cache.json | grep "\"$object_id"\" | awk '{ print $5 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_errors_physical") cat /tmp/storcli_cache/pdisk_cache.json | grep "\"$object_id"\" | awk '{ print $7 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    ###
    "get_status_virtual") cat /tmp/storcli_cache/vdisk_cache.json | grep "\"$object_id"\" | awk '{ print $3 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_raid_virtual") cat /tmp/storcli_cache/vdisk_cache.json | grep "\"$object_id"\" | awk '{ print $4 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_cache_type_virtual") cat /tmp/storcli_cache/vdisk_cache.json | grep "\"$object_id"\" | awk '{ print $5 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_size_virtual") cat /tmp/storcli_cache/vdisk_cache.json | grep "\"$object_id"\" | awk '{ print $6 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    ###
    "get_controller_temp") cat /tmp/storcli_cache/raid_cache.json | grep "\"{#CONTROLLERID}"\":"\"$object_id"\" | awk '{ print $3 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_controller_stat") cat /tmp/storcli_cache/raid_cache.json | grep "\"{#CONTROLLERID}"\":"\"$object_id"\" | awk '{ print $4 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_battery_temp") cat /tmp/storcli_cache/raid_cache.json | grep "\"{#CONTROLLERID}"\":"\"$object_id"\" | awk '{ print $5 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    "get_battery_stat") cat /tmp/storcli_cache/raid_cache.json | grep "\"{#CONTROLLERID}"\":"\"$object_id"\" | awk '{ print $6 }' | sed 's/\"//g' | awk -F":" '{ print $2 }' | sed 's/,//g';;
    ###
